<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hafta6_1.aspx.cs" Inherits="bilgisayar_programciligi.hafta6_1" %>
        ...
        <div>
            <table>
                ...
                <tr>
                    <td>Soyad:</td>
                    <td>
                        <asp:TextBox runat="server" ID="txt_soyad" />  </td>
                </tr>
                <tr>
                    <td>Cinsiyet</td>
                    <td>
                        <asp:DropDownList runat="server" ID="drp_cinsiyet" AutoPostBack="true" OnSelectedIndexChanged="drp_cinsiyet_SelectedIndexChanged">
                ...
                <tr runat="server" id="askerlikPanel" visible="false">
                    <td>Askerlik</td>
                    <td>
                        <asp:DropDownList runat="server" ID="drp_askerlik">
                            <asp:ListItem Value="-1">--Seçiniz--</asp:ListItem>
